...
public class PersonsCsvLoaderTest {
    ...
    public void test2_IdToNameMapping() {
        // id = 1
        Person p1 = store.getPersonById("1");
        ...
        // id = 3
        Person p3 = store.getPersonById("3");
        ...
        // id = 4 
        Person p4 = store.getPersonById("4");
        ...
        // id = 21
        Person p21 = store.getPersonById("21");
    ...
    public void test3_NullFieldsForEmptyValues() {
        ...
        //id = 10
        Person p10 = store.getPersonById("10");
