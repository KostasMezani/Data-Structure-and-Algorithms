...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        // 2) Αν δε δόθηκαν args -> κρατάμε το behavior του Μέρους C (C.3)
        if (args.length == 0){
     ...
     * 1) ./persons.csv (ίδιο working dir)
     * 2) ./Data Structures and Algorithms/persons.csv
     * Αν δε βρεθεί -> πετάει error με cwd.
     */

    private static Path resolvePersonCsvPath(){
        ...
        // ΠΡΟΣΘΗΚΗ - για το nested folder
        Path p3 = Path.of("Data-Structure-and-Algorithms-main",
        ...
        throw new IllegalStateException(
                "Δεν βρέθηκε persons.csv.\n" +
                        "Working dir: " + cwd + "\n" +
                        "Βάλε το persons.csv στο working dir."
        );
    }
}