...
public boolean isFather(String idA, String idB) {
    ...
    if (idA == null || idB == null){ 
        System.out.println("[WARN]: Ένα από τα id's είναι null.");
        return false;
    }
...
// -- D.2 : Παιδί - Αδέλφια --
    ...
    public boolean isSibling(String idA, String idB){
        ...
        boolean bothParentsExist = (fatherA != null && motherA != null &&
                                    fatherB != null && motherB != null);

        //Είναι αδέλφια αν έχουν κοινό πατέρα και μητέρα
        return bothParentsExist && sameFather && sameMother;
    }
    ...
    public boolean isHalfSibling(String idA, String idB){
        if (idA == null || idB == null){
            System.out.println("[WARN]: Ένα απο τα id's είναι null.");
            return false;
        }
    ...
    public String relations(String nameA, String nameB){
        ...
        if (idA == null){
            return "Το όνομα '" + nameA + "' δεν βρέθηκε σε dataset";
        }

        if (idB == null) {
            return "Το όνομα '" + nameB + "' δεν βρέθηκε σε dataset";
        }
